...
public class InsertLikeActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_insert_like);
        ...
        if (getSupportActionBar()!=null){
            getSupportActionBar().setTitle("Create Like Exchange");
                ...
                StringRequest stringRequest = new StringRequest(
                        ...
                        new Response.ErrorListener() {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(InsertLikeActivity.this, error.getMessage(), Toast.LENGTH_LONG).show();
                            }
                        }) {
                };
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if (L != null && T != null) {
                            ...
                            Toast.makeText(InsertLikeActivity.this, "Invalid Link", Toast.LENGTH_LONG).show();
                        }
                    }
                }, 3000);
    ...
    public void Do(){
        if (C>cost1&&views1*cost1<C){
            ...
            DatabaseReference rootRef = FirebaseDatabase.getInstance().getReference();
            rootRef.child("LikeList").child(Uid).child("link").setValue(L);
            rootRef.child("LikeList").child(Uid).child("name").setValue(T);
            rootRef.child("LikeList").child(Uid).child("cost").setValue(cost1);
            rootRef.child("LikeList").child(Uid).child("views").setValue(views1);
            rootRef.child("LikeList").child(Uid).child("image").setValue(imagelink);
            rootRef.child("LikeList").child(Uid).child("viewsDone").setValue(0);
    ...
    public void CheckalreadyaddedViews(){
        final DatabaseReference rootRef = FirebaseDatabase.getInstance().getReference();
        DatabaseReference UBoosterRef = rootRef.child("LikeList");
        ValueEventListener eventListener = new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child(Uid).exists()){
                    ...
                    Toast.makeText(InsertLikeActivity.this, "You Already Have a running campaign", Toast.LENGTH_LONG).show();
                }
            }
